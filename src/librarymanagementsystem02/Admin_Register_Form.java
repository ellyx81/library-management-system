...
public class Admin_Register_Form extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Register_Form
     */
    ...
    private void initComponents() {
        ...
        jLabel12.setText("SIGN UP AS ADMIN");
        ...
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            ...
            if (verifyFields()){
                if(!checkUsername(username))
                {
                    ...
                    ResultSet rs;
                    String registerUserQuery = "INSERT INTO admins (username, password, fname, mname, lname, phone, email, gender) VALUES (?,?,?,?,?,?,?,?)";
...
//CREATE A FUNCTION TO VERIFY THE EMPTY FIELDS
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Register_Form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Register_Form().setVisible(true);
            }
        });
    }
